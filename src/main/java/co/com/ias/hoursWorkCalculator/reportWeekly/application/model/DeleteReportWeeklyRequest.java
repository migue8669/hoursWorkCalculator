...
public class DeleteReportWeeklyRequest implements ApplicationRequest {
    ...
    public DeleteReportWeeklyRequest(String technicianIdentity, String hour, String nightHour, String sundayHour, String extraHour, String extraNightHour, String extraSundayHour, String numWeek) {
        this.technicianIdentity = technicianIdentity;
        this.hour = hour;
        this.nightHour = nightHour;
        this.sundayHour = sundayHour;
    ...
    public boolean equals(Object o) {
        ...
        DeleteReportWeeklyRequest that = (DeleteReportWeeklyRequest) o;
